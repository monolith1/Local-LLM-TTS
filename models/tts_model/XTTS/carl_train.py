...
# BATCH_SIZE * GRAD_ACUMM_STEPS need to be at least 252 for more efficient training

# Define here the dataset that you want to use for the fine-tuning on.
config_dataset = BaseDatasetConfig(
    formatter="ljspeech",
    dataset_name="Carl_20251002",
    path="C:/Users/monol/wkdir/code/llm_tts/wav/input/Carl_Voice_Dataset/",
    meta_file_train="C:/Users/monol/wkdir/code/llm_tts/wav/input/Carl_Voice_Dataset/metadata.csv",
    language="en",
)
...
# Download XTTS v2 checkpoint links
